...
if arquivo is not None:
    ...
    with col2:
        ...
        if "Alto" in classe:
            ...
            mensagem = """
Possível presença de condições favoráveis para a proliferação do mosquito Aedes aegypti.
...
É recomendada uma vistoria preventiva para eliminar possíveis criadouros.
"""
